...
# PLOT 1b: NRIXS with fit resolution function
# -------------

OUTPUTFILE_NRIXS="../NRIXS2_$FILE_NAME.ps"
PDFFILE_NRIXS="../NRIXS2_$FILE_NAME.pdf"

BATCHFILE_NRIXS="NRIXS2.bfile"

# Create the postscript file
xmgrace -batch NRIXS2.bfile -nosafe -hardcopy
...
# PLOT 2b: Resolution Peak Subtraction unzoom
# -----------------------------------

INPUTFILE_PSN="../../Output/$FILE_NAME\_psn.dat"

OUTPUTFILE_PSN="../PeakSub2_$FILE_NAME.ps"
PDFFILE_PSN="../PeakSub2_$FILE_NAME.pdf"

BATCHFILE_PSN="PeakSub2.bfile"
...
# Create the postscript file
xmgrace -batch PeakSub2.bfile -nosafe -hardcopy
