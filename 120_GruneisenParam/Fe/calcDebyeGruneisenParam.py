...
fig.savefig('Results/Fe_DebyeGruneisen_misfit1.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
ax0.set_ylabel(r'$v_{D,0}$',fontsize=16)
ax0.set_title(r'$q=$'+str(q))
fig.savefig('Results/Fe_DebyeGruneisen_misfit2.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
ax0.set_ylabel(r'$v_{D,0}$',fontsize=16)
ax0.set_title(r'$q=$'+str(q))
fig.savefig('Results/Fe_DebyeGruneisen_misfit3.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
fig.savefig('Results/Fe_DebyeGruneisen_misfit4.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
