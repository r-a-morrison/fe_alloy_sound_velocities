...
fig.savefig('Results/FeNi_Gruneisen_misfit.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
ax0.set_xlabel('$q$',fontsize=16)
ax0.set_ylabel('$\gamma_0$',fontsize=16)
fig.savefig('Results/FeNi_Gruneisen_pdf.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
ax0.set_title('q=0.8')
fig.savefig('Results/FeNi_misfit_q0.8.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
# ax0.set_title('q=0.8')
# fig.savefig('Results/FeNi_pdf_q0.8.pdf', format='pdf',
# 	bbox_inches='tight')
# plt.close()
...
# ax0.set_ylim([350,600])
ax0.set_title('q=1.0')
fig.savefig('Results/FeNi_misfit_q1.0.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
...
# ax0.set_ylim([350,600])
ax0.set_title('q=1.2')
fig.savefig('Results/FeNi_misfit_q1.2.pdf', format='pdf',
	bbox_inches='tight')
plt.close()
