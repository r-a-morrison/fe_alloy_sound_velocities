...
ax0.errorbar(bcc_df['V'],bcc_df['fLM'],xerr=bcc_df['dV'],yerr=bcc_df['dfLM'],marker = 'o',
	color = 'gray', mfc='white', ms=markersize, markeredgewidth=1,
	ls='none',elinewidth=1, label='Fe')
hcp_df = input_df[input_df['Phase']=='hcp']
ax0.errorbar(hcp_df['V'],hcp_df['fLM'],xerr=hcp_df['dV'],yerr=hcp_df['dfLM'],marker = 'o',
...
ax0.errorbar(bcc_df['V'],bcc_df['fLM'],xerr=bcc_df['dV'],yerr=bcc_df['dfLM'],
...
ax0.errorbar(hcp_df['V'],hcp_df['fLM'],xerr=hcp_df['dV'],yerr=hcp_df['dfLM'],
...
ax0.set_ylabel(r'$f_{LM}$',fontsize = 16)
ax0.set_xlim([15,24])
ax0.set_ylim([0.76,0.93])
...
fig.savefig('Plots/fLM.pdf', format='pdf',
	bbox_inches='tight')
plt.close()


# Plot fLM vs P for comparison
##############################
...
ax0.errorbar(lit_df['P'],lit_df['fLM'],xerr=lit_df['dP'],yerr=lit_df['dfLM'],
...
input_df = input_dict['Fe']
bcc_df = input_df[input_df['Phase']=='bcc']
ax0.errorbar(bcc_df['P'],bcc_df['fLM'],xerr=bcc_df['dP'],yerr=bcc_df['dfLM'],marker = 'o',
	color = 'gray', mfc='white', ms=markersize, markeredgewidth=1,
	ls='none',elinewidth=1, label='')
hcp_df = input_df[input_df['Phase']=='hcp']
ax0.errorbar(hcp_df['P'],hcp_df['fLM'],xerr=hcp_df['dP'],yerr=hcp_df['dfLM'],marker = 'o',
	color = 'gray', mfc='lightgray', ms=markersize, markeredgewidth=1,
	ls='none',elinewidth=1, label='')
...
fig.savefig('Plots/fLM_vs_P.pdf', format='pdf',
	bbox_inches='tight')
plt.close()


# Plot fLM for Fe Murphy comparison
###########
...
ax0.errorbar(lit_df['V'],lit_df['fLM'],xerr=lit_df['dV'],yerr=lit_df['dfLM'],
...
fig.savefig('Plots/fLM_MurphyComp.pdf', format='pdf',
	bbox_inches='tight')
plt.close()